...
class AuthProvider extends ChangeNotifier {
      ...
      await _firebaseAuth.verifyPhoneNumber(
          ...
          codeSent: (verificationId, forceResendingToken) {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        OTP_Page(verificationId: verificationId)));
          },
  ...
  //database Operations
  Future<bool> chcekExistingUser() async {
  ...
  void saveUserDataToFirebase({
    ...
    try {
      ...
      await _firebaseFirestore.collection("fav").doc(_uid).set(fav);
