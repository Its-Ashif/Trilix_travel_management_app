      ...
      child: Column(children: [
        ...
        Row(
          ...
          children: [
            GestureDetector(
                onTap: () {
                  changeDepurtureTrainStatus(widget.trainName, 'SL');
                            ...
                            ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  setState(() {
                                    ...
                                    class_Name = 'SL';
                                    depurturetotal = (int.parse(widget.sl) *
                                        int.parse(
            ...
            GestureDetector(
                onTap: () {
                  changeDepurtureTrainStatus(widget.trainName, '3A');
                  showBottomSheet<void>(
                      elevation: 1,
                      context: context,
                      backgroundColor: Colors.transparent,
                            ...
                            ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  setState(() {
                                    train_Name = widget.trainName;
                                    class_Name = '3A';
                                    depurturetotal = (int.parse(widget.a3) *
                                        int.parse(
                                            peoplecountController.toString()));
                                  });
                                },
            ...
            GestureDetector(
                onTap: () {
                  changeDepurtureTrainStatus(widget.trainName, '2A');
                  showBottomSheet<void>(
                      elevation: 1,
                      context: context,
                      backgroundColor: Colors.transparent,
                            ...
                            ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  setState(() {
                                    train_Name = widget.trainName;
                                    class_Name = '2A';
                                    depurturetotal = (int.parse(widget.a2) *
                                        int.parse(
                                            peoplecountController.toString()));
                                  });
                                },
            ...
            GestureDetector(
                onTap: () {
                  changeDepurtureTrainStatus(widget.trainName, '1A');
                  showBottomSheet<void>(
                      elevation: 1,
                      context: context,
                      backgroundColor: Colors.transparent,
                                ...
                                onPressed: () {
                                  setState(
                                    () {
                                      train_Name = widget.trainName;
                                      class_Name = '1A';
                                      depurturetotal = (int.parse(widget.a1) *
